...
class ConfigEditor(wx.Panel):
    ...
    def _setup_editor(self):
        ...
        self.editor.StyleSetSpec(stc.STC_YAML_IDENTIFIER, "fore:#0000FF,bold")  # Keys
        self.editor.StyleSetSpec(stc.STC_YAML_KEYWORD, "fore:#0000FF,bold")
        ...
        self.editor.StyleSetSpec(stc.STC_YAML_COMMENT, "fore:#808080,italic")
